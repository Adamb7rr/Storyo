      ...
      <main className={`flex-1 p-8 pt-20 md:pt-8 transition-all duration-300
        ...
        >
          ...
          <h1 className={` text-4xl font-bold mb-3 py-3 text-center
            ...
            <p className="py-3 text-lg font-bold text-gray-500 lg:text-xl dark:text-gray-400">Welcome to <span className="text-4xl text-transparent bg-clip-text bg-gradient-to-r to-Azure-600 from-blue-violet-400">Storyo</span>, an AI-driven platform for generating creative stories.</p>
          </h1>
